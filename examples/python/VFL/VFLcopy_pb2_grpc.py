...
import VFLcopy_pb2 as VFLcopy__pb2
...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Aggregate = channel.stream_stream(
                ...
                request_serializer=VFLcopy__pb2.partialsum.SerializeToString,
                response_deserializer=VFLcopy__pb2.loss.FromString,
                )
...
def add_GreeterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Aggregate': grpc.stream_stream_rpc_method_handler(
                    servicer.Aggregate,
                    request_deserializer=VFLcopy__pb2.partialsum.FromString,
                    response_serializer=VFLcopy__pb2.loss.SerializeToString,
            ),
    }
...
class Greeter(object):
    ...
    def Aggregate(request_iterator,
        ...
        return grpc.experimental.stream_stream(request_iterator, target, '/helloworld.Greeter/Aggregate',
            VFLcopy__pb2.partialsum.SerializeToString,
            VFLcopy__pb2.loss.FromString,
